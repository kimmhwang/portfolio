...
/* Work-in-progress banner (top strip; scrolls away above the sticky nav) */
.pv2 .wip-banner{ background:var(--accent); color:var(--btn-ink); font-family:var(--mono); font-size:11px; letter-spacing:2px; text-transform:uppercase; text-align:center; padding:9px 16px; line-height:1.4; }
