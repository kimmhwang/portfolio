...
export const CONTENT = {
  hero: {
    eyebrow: "Bioengineer · Healthcare Strategy · Medical Devices",
    headlinePre: "Moving medical innovation from lab to ",
    headlineHighlight: "last mile.",
    subhead:
      "I work where medical technology meets strategy — from R&D and regulatory submissions to market access and the partnerships that move a product from lab to clinic. Trained as a bioengineer, fluent across the clinical, commercial, and technical sides of healthcare.",
    ctas: [
    ...
    captionRight: "Open to strategy & MedTech roles",
  },
...
/* ─── DRAFT CHANGELOG (content.draft.js — not imported by the live site) ───────
   Review pass 1 (consistency/proofing): $265K normalized; "4 Publications & posters";
     howiwork#03 deduped; Mosaic added to Experience; Ocular title aligned;
     dead "#" pub links removed; "Ideas in progress"→"Recent thinking";
     "coming soon" dropped; Work trimmed 8→5 (mentored dupes live in Mentorship).
   Review pass 3 (extend catering): About rewritten (co-founder + strategy/funding/
     regulatory range, deduped triad); Work tagline → "R&D, regulatory strategy,
     global-health delivery"; Mentorship DE-ACADEMIZED — reframed from teaching/instructor
     to leading multidisciplinary teams (per Kim: do not position as an academician).
   Review pass 2 (bridge-year role fit — Intro / How I work / Mentorship):
     Catered toward healthcare strategy consulting, biotech/medtech BD, healthcare VC,
     market access/HEOR, and SG innovation roles (A*STAR/IPOS/SGInnovate). Surfaced
     strategy + commercial + cross-functional + analytical signals; kept global-health core.
     Med-school path deliberately OFF the public site (Tier 1/2 disclosure strategy).
   NOTE: hero headline changed from the established "Building technology that reaches
     the last mile." — that line is also the OG meta description in app/layout.js;
     sync or revert there if this headline ships.
   To go live: point app/page.jsx import to ./content.draft.js, or copy over content.js.
─────────────────────────────────────────────────────────────────────────────── */
